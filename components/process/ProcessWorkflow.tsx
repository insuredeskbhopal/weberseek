    ...
    <section className="section-block" id="process">
      <div className="section-container">
        ...
        <div className="process-vertical-list">
          ...
          {[
            {
              phase: '01', title: 'Scope & Strategy', img: '/images/process/process_01_strategy.webp', alt: 'Scope and Strategy Consultation',
            ...
            {
              phase: '02', title: 'Interactive UI/UX Design', img: '/images/process/process_02_design.webp', alt: 'Interactive UI UX Design Session',
            ...
            {
              phase: '03', title: 'Sprint-Based Development', img: '/images/process/process_03_development.webp', alt: 'Sprint-Based Software Engineering',
            ...
            {
              phase: '04', title: 'Testing & Speed Tuning', img: '/images/process/process_04_testing.webp', alt: 'Cross-Device Quality Assurance Testing',
            ...
            {
              phase: '05', title: 'Launch & 30-Day Support', img: '/images/process/process_05_launch.webp', alt: 'Successful Live Product Launch',
